...
set(CMAKE_C_FLAGS "-Os -g -Wpointer-arith -Werror -Wl,-EL -fno-inline-functions -nostdlib -mlongcalls -mtext-section-literals -ffunction-sections -fdata-sections -DICACHE_FLASH -DESP8266" CACHE STRING "C compiler flags")
set(CMAKE_CXX_FLAGS "-Os -g -Wpointer-arith -Werror -Wl,-EL -fno-exceptions -fno-rtti -fno-inline-functions -nostdlib -mlongcalls -mtext-section-literals -ffunction-sections -fdata-sections -DICACHE_FLASH -DESP8266" CACHE STRING "C++ compiler flags")
...
set(ESP8266_HOME ${CMAKE_CURRENT_LIST_DIR} CACHE PATH "ESP8266 Home Directory" FORCE)
